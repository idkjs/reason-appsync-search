...
var ppx_printed_query = "query listAll  {\nlistIceCreams  {\nitems  {\nname  \ndescription  \nid  \nrating  \n}\n\n}\n\n}\n";
                        ...
                        if (match !== undefined) {
                          ...
                          if (match$1 !== undefined) {
                            ...
                            if (match$2 !== undefined) {
                              ...
                              field_name = match$3 !== undefined ? match$3 : Js_exn.raiseError("graphql_ppx: Expected string, got " + JSON.stringify(value$2));
                            } else {
                            ...
                            if (match$4 !== undefined) {
                              ...
                              field_description = match$5 !== undefined ? match$5 : Js_exn.raiseError("graphql_ppx: Expected string, got " + JSON.stringify(value$3));
                            } else {
                              field_description = Js_exn.raiseError("graphql_ppx: Field description on type IceCream is missing");
                            }
                            var match$6 = Js_dict.get(value$1, "id");
                            var field_id;
                            if (match$6 !== undefined) {
                              var value$4 = Caml_option.valFromOption(match$6);
                              var match$7 = Js_json.decodeString(value$4);
                              field_id = match$7 !== undefined ? match$7 : Js_exn.raiseError("graphql_ppx: Expected string, got " + JSON.stringify(value$4));
                            } else {
...
var ListIceCreamsQuery = ReasonApollo.CreateQuery([
      ppx_printed_query,
      parse
    ]);

var component = ReasonReact.statelessComponent("ListIceCreams");
...
function make$1(_children) {
  return /* record */[
          ...
          /* render */(function (param) {
              make(/* () */0);
              return ReasonReact.element(undefined, undefined, Curry.app(ListIceCreamsQuery[/* make */3], [
                              undefined,
                              undefined,
                              undefined,
                              undefined,
                                    ...
                                    if (items !== undefined) {
                                      ...
                                      return React.createElement("div", undefined, React.createElement("ul", undefined, $$Array.map((function (item) {
                                                            return React.createElement("li", {
                                                                        key: item[/* id */0]
                                                                      }, React.createElement("p", undefined, item[/* name */1]));
                                                          }), items$1)));
                                    } else {
...
exports.make = make$1;
/* ListIceCreamsQuery Not a pure module */
